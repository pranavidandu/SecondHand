...
.panel-heading {background-color: #4791DA!important}
</style>
</head>
<body>
...
<div class="container tablediv">
  ...
  <div class="panel-group">
    <div class="panel panel-default">
      ...
      <div class="form-group">
  <input type="text" class="form-control" name="adtitle" placeholder = "Enter AdTitle">
</div></div>
   
    <div class="panel panel-default">
      <div class="panel-heading">Category</div>
      <div class="panel-body"><div class="form-group">
  <input type="text" class="form-control" name="category" placeholder = "Select a Category">
</div></div>
  ...
  <textarea class="form-control" rows="5" name="addescription"></textarea>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
      <img src="./IMG/upload.png" class="img-thumbnail" alt="cannot upload" width="100" height="100">
      &nbsp;
      <img src="./IMG/upload.png" class="img-thumbnail" alt="cannot upload" width="100" height="100">
      &nbsp;
      <img src="./IMG/upload.png" class="img-thumbnail" alt="cannot upload" width="100" height="100">
      ...
      <div class="panel-body">  <div class="panel-body"><div class="form-group">
  <input type="text" class="form-control" name="price" maxlength = "10" placeholder = "Enter Price">
</div></div>
    </div>
    <div class="panel panel-default">
  ...
  <input type="text" class="form-control" name="names" placeholder = "Enter Name">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">  <div class="panel-body"><div class="form-group">
  <input type="text" class="form-control" name="emails" placeholder = "Enter Email" value = <%=email%>>
</div></div>
    </div>
     <div class="panel panel-default">
...
</div><br><label class="checkbox-inline"><input type="checkbox" value="" name="availableonwhatsapp">Available on whatsapp</label></div>
    </div>
     <div class="panel panel-default">
