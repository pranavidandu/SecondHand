 ...
 * Generated at: 2015-06-19 23:47:54 UTC
...
public final class ads_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(email == null) {
      ...
      out.write("\t\t\t<h3>\n");
      out.write("\t\t\t\t<form action=\"AdsController\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Ear Phones</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Case Covers</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Computers</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Cds</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Camera</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Video Games</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>TV</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Other Electronics</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Cars</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Motorcycle</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Scooters</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Bicycles</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Commercial Vehicles</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Other Vehicles</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Furniture</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Decor</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Fridge and AC</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Kitchen Appliances</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Paintings and Handicrafts</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Dogs</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Aquarium and Fishes</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Birds</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Cats</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Animal food</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Other Animals</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Books</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Musical Instruments</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Sports</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Fitness</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Coins and Collectibles</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Clothes</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Shoes</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Jewellary</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Bags</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Watches</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Health and Beauty</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Strollers</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Kid Furnitures</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Car Seat</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Nutrition</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Kid Clothing</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option>Toys and Games</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
